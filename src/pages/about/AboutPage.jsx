    ...
    return (
        <>
            <Box>
                ...
                <Box
                    style={{
                        background: mode === 'dark' ? 'var(--swat5)' : '',
                    }}
                    sx={{
                        width: '100%',
                ...
                >
                    <Container maxWidth='md'>
                        ...
                        <Fade bottom>
                            ...
                            >
                                Delightful family development Initiative (DFDI) was born out of a
                                strong desire to restore love, happiness and stability to families.
                                It is also aimed at grooming singles for happy marriage.
                            </Typography>
                        </Fade>
                        <br />
                        <Fade bottom>
                            ...
                            >
                                ...
                                and singles. And since then the Initiative has been holding a
                                quarterly seminar captured <b> “Marriage on the Rock” </b>, which
                                has recorded numerous testimonies from attendance such as healing
                                and restoration of broken homes, marriages, relationships and
                                families.
                            </Typography>
                        </Fade>
                        <br />
                        <Fade bottom>
                            ...
                            >
                                ...
                                necessary tools/information for preparing for marriage. This has in
                                turn inspired many into the marriage institution.
                            </Typography>
                        </Fade>
                    </Container>
                </Box>
