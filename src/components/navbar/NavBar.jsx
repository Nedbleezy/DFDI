    ...
    return (
        <>
            ...
            >
                ...
                >
                    {mode === 'light' ? (
                        <Typography variant='span' sx={{ fontSize: '.5rem' }}>
                            {' '}
                            light theme <DarkModeIcon onClick={() => setMode('dark')} />
                        </Typography>
                    ) : (
                        <Typography variant='span' sx={{ fontSize: '.5rem' }}>
                            dark theme <Brightness5Icon onClick={() => setMode('light')} />
                        </Typography>
                    )}
                </Box>
                <div>
                                ...
                                >
                                    ...
                                    >
                                        {mode === 'light' ? (
                                            ...
                                            <Typography variant='span' sx={{ fontSize: '.5rem' }}>
                                                dark theme{' '}
                                                <Brightness5Icon onClick={() => setMode('light')} />
                                            </Typography>
                                        )}
                                    </Box>
                                </Box>
